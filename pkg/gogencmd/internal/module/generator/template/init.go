...
var Init = assets.NewFileSystem(map[string][]string{"/app": []string{"run.go.tmpl"}, "/app/server": []string{".keep.tmpl"}, "/cmd": []string{}, "/": []string{".gitignore.tmpl", "Gopkg.toml.tmpl", "gogen.toml.tmpl"}, "/api": []string{}, "/cmd/server": []string{"run.go.tmpl"}, "/api/protos": []string{".keep.tmpl"}, "/api/protos/type": []string{".keep.tmpl"}}, map[string]*assets.File{
