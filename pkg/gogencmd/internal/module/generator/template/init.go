...
var Init = assets.NewFileSystem(map[string][]string{"/app": []string{"run.go.tmpl"}, "/app/server": []string{".keep.tmpl"}, "/api": []string{}, "/api/protos": []string{".keep.tmpl"}, "/api/protos/type": []string{".keep.tmpl"}, "/": []string{"Gopkg.toml.tmpl", ".gitignore.tmpl", "gogen.toml.tmpl"}, "/cmd": []string{}, "/cmd/server": []string{"run.go.tmpl"}}, map[string]*assets.File{
	"/app": &assets.File{
		Path:     "/app",
		FileMode: 0x800001ed,
