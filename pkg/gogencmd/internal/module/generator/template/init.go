...
var Init = assets.NewFileSystem(map[string][]string{"/app/server": []string{".keep.tmpl"}, "/api": []string{}, "/api/protos/type": []string{".keep.tmpl"}, "/": []string{"Gopkg.toml.tmpl", ".gitignore.tmpl", "gogen.toml.tmpl"}, "/api/protos": []string{".keep.tmpl"}, "/cmd": []string{}, "/cmd/server": []string{"run.go.tmpl"}, "/app": []string{"run.go.tmpl"}}, map[string]*assets.File{
	"/cmd": &assets.File{
		Path:     "/cmd",
		FileMode: 0x800001ed,
