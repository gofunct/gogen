...
var Init = assets.NewFileSystem(map[string][]string{"/api/protos": []string{".keep.tmpl"}, "/api/protos/type": []string{".keep.tmpl"}, "/cmd": []string{}, "/": []string{"Gopkg.toml.tmpl", ".gitignore.tmpl", "grapi.toml.tmpl"}, "/app/server": []string{".keep.tmpl"}, "/api": []string{}, "/cmd/server": []string{"run.go.tmpl"}, "/app": []string{"run.go.tmpl"}}, map[string]*assets.File{
